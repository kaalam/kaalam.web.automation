...
path <- paste(c(DOC_FOLDERS$input, DOC_FOLDERS$jekyllpath, DOX1_FOLDERS$input, DOX2_FOLDERS$input, KAAL_FOLDERS$input, KAAL_FOLDERS$jekyllpath,
				PYCL_FOLDERS$input, RCLI_FOLDERS$input, STAT_FOLDERS$input), collapse = ' ')
